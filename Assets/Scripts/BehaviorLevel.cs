	...
	void Update () {
	    ...
	    if (Input.GetMouseButtonDown(0) || refresh)
	    {
	        ...
	        else
	        {
                ...
                else if (_enemies[clickTilePosition.x, clickTilePosition.y] != null && Statics.MovingToTileCost(clickTilePosition, _activePlayer) <= _activePlayer.GetComponent<PlayerActions>().Items[_activePlayer.GetComponent<PlayerActions>().ActiveItem].GetComponent<ItemProperties>().RangeInActionpoints && _activePlayer.GetComponent<PlayerActions>().Items[_activePlayer.GetComponent<PlayerActions>().ActiveItem].GetComponent<ItemProperties>().isWeapon && _activePlayer.GetComponent<PlayerActions>().ActionPoints - actionQ.SpentActionPointsForPlayer(_activePlayer) >= _activePlayer.GetComponent<PlayerActions>().Items[_activePlayer.GetComponent<PlayerActions>().ActiveItem].GetComponent<ItemProperties>().UsageCostInActionpoints && _activePlayer.GetComponent<PlayerActions>().ActiveItem > 0)
                {
